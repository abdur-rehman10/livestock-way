...
const RESOURCES_MESSAGES_BASE = `${API_BASE_URL}/api/resources-messages`;
...
export async function fetchUserResourcesThreads(): Promise<ResourcesApplicationThread[]> {
  const response = await fetch(`${RESOURCES_MESSAGES_BASE}/threads`, {
...
export async function fetchResourcesThreadById(threadId: number): Promise<ResourcesApplicationThread> {
  const response = await fetch(`${RESOURCES_MESSAGES_BASE}/threads/${threadId}`, {
    headers: buildHeaders("GET", false),
  });
...
export async function fetchResourcesThreadByListingAndApplication(
  listingId: number,
  applicationId: number
): Promise<ResourcesApplicationThread> {
  const response = await fetch(`${RESOURCES_MESSAGES_BASE}/threads/by-listing/${listingId}/${applicationId}`, {
    headers: buildHeaders("GET", false),
  });
...
export async function fetchResourcesThreadMessages(threadId: number): Promise<ResourcesApplicationMessage[]> {
  const response = await fetch(`${RESOURCES_MESSAGES_BASE}/threads/${threadId}/messages`, {
    headers: buildHeaders("GET", false),
  });
...
export async function sendResourcesMessage(
  threadId: number,
  message: string,
  attachments?: any[]
