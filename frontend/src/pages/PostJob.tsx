...
export default function PostJob() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success("Job listing is now live.", {
        description: "Qualified candidates will be notified and can apply immediately.",
      });
              ...
              <Card className="border-2 shadow-lg">
                <CardHeader className="pb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <CardTitle className="text-xl">Location & Pay</CardTitle>
                  </div>
                  <CardDescription>Where the job is and what it pays</CardDescription>
                </CardHeader>
                <CardContent className="space-y-5">
                  <div className="space-y-2">
                ...
                <Card className="border-2 shadow-lg">
                  <CardHeader className="pb-4">
                    <div className="flex items-center gap-2">
                      ...
                      <CardTitle className="text-xl">Benefits Offered</CardTitle>
                    </div>
                    <CardDescription>Select benefits you offer with this position</CardDescription>
                  </CardHeader>
                  <CardContent>
