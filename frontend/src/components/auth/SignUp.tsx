...
export function SignUp({ onBack, onSelectRole, onViewPricing, onShowEnterprisePricing }: SignUpProps) {
  const roles = [
    {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <Card className="w-full max-w-3xl p-5">
        ...
        <div className="text-center mb-5">
          <h2 className="text-xl mb-1">Complete Your Profile</h2>
          <p className="text-gray-600 text-sm">Select your role to get started</p>
        </div>
