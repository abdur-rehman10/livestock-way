      ...
      <div className="min-h-screen w-full bg-slate-50 dark:bg-slate-900 transition-colors">
        <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-sm">
            <div className="space-y-4 sm:space-y-5 p-4 sm:p-5 lg:p-6 pb-6">
              {/* Basic Information */}
              <FormSection
                icon={Wrench}
            ...
            <div className="border-t border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-4 sm:px-5 lg:px-6 py-4 rounded-b-xl">
              <div className="flex flex-col-reverse sm:flex-row gap-2 sm:gap-3 sm:justify-end">
                <Button
                  type="button"
                  variant="outline"
                  className="h-10 sm:h-11 w-100 sm:w-auto border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700 sm:px-6 text-sm sm:text-base font-medium"
                  onClick={onCancel}
                ...
                <Button
                  ...
                  className="h-10 sm:h-6 w-100 sm:w-auto"
                  disabled={isSubmitting || (values.priceType !== 'quote' && !values.basePrice)}
                >
